...
<!-- Ficha de Torneos del Dragón -->
<div class="card">
        <h3>Habilidades de personaje</h3>
        <p>Mejora las Habilidades de tus personajes.</p>
        <a href="dashboardTournaments.php">Ver Habilidades</a>
    </div>

    <!-- Ficha de Torneos del Dragón -->
    <div class="card">
        <h3>agregar amigos</h3>
        <p>agrega a tus amigos para jugar en linea.</p>
        <a href="dashboardTournaments.php">Ver solicitudes</a>
    </div>
